...
(function () {
    ...
    var ws;
    var player;
    var BOT_SETTINGS_TEMPLATE = '<style>.bot-settings{padding: 10px; background-color: rgba(33, 240, 255, 0.4); border-radius: 0px; position: absolute; left: 20px; top: 20px; min-width: 200px; max-width: 300px;aw}.equip-btn{display:inline-block; width: 25px; height: 25px; border: 1px solid grey; background-size: contain; cursor: pointer; background-color: lightgray;}.equip-btn.selected{background-color: rgb(30, 64, 255);}</style><div class="bot-settings"> <div> <div> <input type="checkbox" id="botAutoHealOn"/> <label for="botAutoHealOn">AUTO SOUP / AUTO HEAL</label> </div></div><hr/> <div id="bot-equips-0"> </div><hr/><div id="bot-equips-1"> </div></div>';
...
// document.getElementById('promoImgHolder').innerHTML = '<iframe width="420" height="236.25" src="https://www.youtube.com/embed/Tw7s0GhSWPQ?rel=0&amp;controls=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>';
// document.getElementById('adCard').innerHTML = '<iframe width="420" height="236.25" src="https://www.youtube.com/embed/Agb9e6ThTdY?rel=0&amp;controls=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>';
// document.getElementById('downloadButtonContainer').innerHTML = '<iframe src='http://music.dawnfoxes.com/embed/?song=11c556116ebaf3ed79ad81e5f1e02588dd482088448012bddda316b70172520f436a69abebaf13f8d457bb00b13215c0343665099c7870d356199133f73f37a8' class="fitignore" width='100%' height='115' frameborder='0'></iframe>';
...
document.getElementById('loadingText').innerHTML = 'Hacking in Style';
...
document.getElementById('gameName').innerHTML = '🐺Stealth🐺';
...
$('#foodDisplay').css({'color': '#ffffff'});

$('#woodDisplay').css({'color': '#ffffff'});

$('#stoneDisplay').css({'color': '#ffffff'});

$('#scoreDisplay').css({'color': '#ffffff'});
